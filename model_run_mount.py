...
data = test_diags.model(dt=900,Nt=192000,gamma_q=0,r_BD=0,r_diff=2,tau_0=0,rho_0=1000,dumpFreq=86400,meanDumpFreq=864000,diags=diagnostics)
data.to_netcdf('./model_data/FDT_MOUNT_2km_2000days')
